...
既然是美化，必然以性能损失为代价。所以在动手实践之前，请认真考虑好电脑硬件配置是否能承受以及自身对性能损失的忍耐力是多大。每一项美化后我都将借自己的感受在此项上做分析，希望为大家的选择提供参考。

So long as a beautifying effort, there are inevitable performance loss as costs. Before implementing on Windows 10, please think twice on whether your computer hardware can handle, and whether the performance loss is within tolerance. I will for specify this point from my user-experience for illustration, solely for your reference and decision.

## 设计思路

目前仅支持深色模式，浅色背景还在测试调色阶段。

Only Dark mode is available for the moment, the Light mode is still under development.
