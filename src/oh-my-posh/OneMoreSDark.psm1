...
function Write-Theme {
    ...
    if ($with) {
        ...
        $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptHighlightColor -BackgroundColor $sl.Colors.PromptIndicatorColor1
    }
