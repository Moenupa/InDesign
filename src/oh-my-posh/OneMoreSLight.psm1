...
function Write-Theme {
    ...
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentBackwardSymbol -ForegroundColor $sl.Colors.PromptStartIndicatorColor1

    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentBackwardSymbol -ForegroundColor $sl.Colors.PromptStartIndicatorColor2 -BackgroundColor $sl.Colors.PromptStartIndicatorColor1
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentBackwardSymbol -ForegroundColor $sl.Colors.PromptStartIndicatorColor3 -BackgroundColor $sl.Colors.PromptStartIndicatorColor2
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentBackwardSymbol -ForegroundColor $sl.Colors.AdminIconBackgroundColor -BackgroundColor $sl.Colors.PromptStartIndicatorColor3
    ...
    if (Test-NotDefaultUser($user)) {
        $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentBackwardSymbol -ForegroundColor $sl.Colors.PromptBackgroundColor -BackgroundColor $sl.Colors.AdminIconBackgroundColor
    ...
    if (Test-VirtualEnv) {
        $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentBackwardSymbol -ForegroundColor $sl.Colors.VirtualEnvBackgroundColor -BackgroundColor $sl.Colors.AdminIconBackgroundColor
    ...
    if ($with) {
        $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptHighlightColor -BackgroundColor $sl.Colors.WithBackgroundColor
        ...
        $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.WithBackgroundColor -BackgroundColor $sl.Colors.PromptIndicatorColor1
    } else {
        $prompt += Write-Prompt -Object ' '
        $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptForegroundColor -BackgroundColor $sl.Colors.PromptIndicatorColor1
    }
    
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptIndicatorColor1 -BackgroundColor $sl.Colors.PromptIndicatorColor2
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptIndicatorColor2 -BackgroundColor $sl.Colors.PromptIndicatorColor3
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptIndicatorColor3
    $prompt += ' '
    $prompt
}
