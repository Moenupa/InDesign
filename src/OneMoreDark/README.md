...
OneMore 暗色主题是一款基于 VS Code 暗色主题的低对比度主题（均基于底色 `#1E1E1E` ），目前适配于 Windows Terminal, Notepad++ 等应用。
...
|Cyan|DarkCyan|![#80FFCC](https://github.com/Moenupa/InDesign/blob/master/res/demo/OneMoreDark/80FFCC.png)![#66CCA3](https://github.com/Moenupa/InDesign/blob/master/res/demo/OneMoreDark/66CCA3.png)
